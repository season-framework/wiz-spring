...
# WIZ Spring documentation

The root [README](../README.md) is the shortest path to a running project. Use the
guides below when you need the generation contract, deployment model, or migration
details.

| Guide | Covers |
| --- | --- |
| [Project generation](project-generation.md) | 1.2.0 version baseline, requirements, CLI, templates, imports, and sample application |
...
For the complete command-line options, use the installed CLI:
