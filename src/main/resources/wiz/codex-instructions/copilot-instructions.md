...
```bash
java -jar target/wiz-spring-0.2.7.jar --help
java -jar target/wiz-spring-0.2.7.jar create <workspace> --package com.example.demo
java -jar target/wiz-spring-0.2.7.jar build --root <workspace> --clean
java -jar target/wiz-spring-0.2.7.jar build --root <workspace> --package com.example.renamed
java -jar target/wiz-spring-0.2.7.jar jar --root <workspace> --output /tmp/demo.jar
java -jar target/wiz-spring-0.2.7.jar run --root <workspace> --port 3000
source <(java -jar target/wiz-spring-0.2.7.jar completion bash)
```
