...
It is the WIZ Spring `1.2.2` contract: Java release 25, Spring Boot `4.1.1`,
Boot-managed Spring Framework `7.0.9`, springdoc `3.1.0`, Maven Wrapper `3.9.15`, and the Node.js range declared in
