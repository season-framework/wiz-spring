...
public class ChatEventHub {
    ...
    public SseEmitter connect(Supplier<List<ChatMessageResponse>> replay) {
        ...
        try {
            ...
            for (ChatMessageResponse message : replay.get()) {
    ...
    private void send(SseEmitter emitter, ChatMessageResponse message) throws IOException {
