...
A small, Docker-only HTTP service that turns WIZ Spring `1.2.2` project
templates into downloadable ZIP archives. It is intended for internal tooling,
CI, and `curl`-based project bootstrapping.

> [!IMPORTANT]
> This helper creates new WIZ Spring `1.2.2` projects. It is not compatible
...
- A locally built `target/wiz-spring-1.2.2.jar`
